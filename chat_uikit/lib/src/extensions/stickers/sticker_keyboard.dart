  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child:
          //---loading widget---
          isLoading
          ? _getLoadingIndicator(colorPalette, spacing, typography)
          //---on error---
          : isError
          ? _getOnError(context, colorPalette, spacing, typography)
          : stickerSets.isEmpty
          ? _getEmptyView(context, colorPalette, spacing, typography)
          : Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Expanded(
