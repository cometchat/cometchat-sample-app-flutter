...
class StatusIndicatorUtils {
  ...
  static StatusIndicatorUtils getStatusIndicatorFromParams({
    ...
    if (isSelected == true) {
      icon =
          selectIcon ??
          Icon(Icons.check, color: selectIconTint ?? Colors.white, size: 12);
