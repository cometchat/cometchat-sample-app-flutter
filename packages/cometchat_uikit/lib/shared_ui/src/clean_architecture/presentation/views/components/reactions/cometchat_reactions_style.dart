...
class CometChatReactionsStyle extends ThemeExtension<CometChatReactionsStyle> {
  ...
  @override
  CometChatReactionsStyle lerp(
    covariant ThemeExtension<CometChatReactionsStyle>? other,
    double t,
  ) {
    ...
    return CometChatReactionsStyle(
      ...
      activeReactionBackgroundColor: Color.lerp(
        activeReactionBackgroundColor,
        other.activeReactionBackgroundColor,
        t,
      ),
      activeReactionBorder: Border.lerp(
        activeReactionBorder as Border?,
        other.activeReactionBorder as Border?,
        t,
      ),
