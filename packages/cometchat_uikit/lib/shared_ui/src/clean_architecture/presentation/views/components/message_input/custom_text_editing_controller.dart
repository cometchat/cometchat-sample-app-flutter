...
class CustomTextEditingController extends TextEditingController {
  ...
  List<InlineSpan> buildSpan(
    ...
    final attributions = collectAttributions(context, style, withComposing);
  ...
  List<AttributedText> collectAttributions(
    ...
    for (final formatter in formatters ?? []) {
      final formatterAttributions = formatter.buildInputFieldText(
        text: text,
        style: style,
        context: context,
        withComposing: withComposing,
      );
      attributions.addAll(formatterAttributions);
    }
