...
class CometChatAIConversationStarterStyle
    extends ThemeExtension<CometChatAIConversationStarterStyle> {
  ...
  static CometChatAIConversationStarterStyle of(BuildContext context) =>
      const CometChatAIConversationStarterStyle();
