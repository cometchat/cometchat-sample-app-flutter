...
///
/// This style class follows the Clean Architecture pattern and extends [ThemeExtension]
/// for proper theme integration.
///
/// ## Example
/// ```dart
...
class CometChatMessageListStyle
  ...
  /// Returns a default [CometChatMessageListStyle] from the current theme context.
  ///
  /// This method provides theme access following the established pattern.
  ///
  ...
  ///
  /// This method provides immutable updates following the established pattern.
  ///
  ...
  /// Merges this style with another [CometChatMessageListStyle].
  ///
  /// The [other] style's non-null properties will override this style's properties.
  /// If [other] is null, returns this style unchanged.
  ///
  ...
  /// Linearly interpolates between two [CometChatMessageListStyle] instances.
  ///
  /// The [t] parameter represents the interpolation factor:
  /// - When t = 0.0, returns this style
  /// - When t = 1.0, returns [other] style
  /// - Values between 0.0 and 1.0 return an interpolated style
  ///
  /// This method is used for smooth animations between style states.
  ///
  ...
  CometChatMessageListStyle lerp(CometChatMessageListStyle? other, double t) {
    ...
    return CometChatMessageListStyle(
      ...
      emptyChatGreetingSubtitleTextStyle: TextStyle.lerp(
          ...
          t),
      newMessageIndicatorStyle:
          t < 0.5 ? newMessageIndicatorStyle : other.newMessageIndicatorStyle,
    );
  }
}
