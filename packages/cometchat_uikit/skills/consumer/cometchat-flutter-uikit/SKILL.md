...
The `cometchat_calls_sdk` (v5.0.0-beta.3) is bundled as a transitive dependency — you don't need to add it separately. To use call features, import the calls barrel:
```dart
