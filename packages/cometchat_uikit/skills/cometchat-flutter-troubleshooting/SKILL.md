...
### 3.2 No typing indicators / presence events
...
### 3.3 Messages not updating in real-time
...
- **Cause**: Multiple possible causes:
  ...
  2. `subscriptionType` not set (see 3.2)
...
### 3.4 Theme jank during keyboard animation
...
### 3.5 Extra white space between composer and keyboard
...
- **Fix**: Cache theme values in `didChangeDependencies()` — see Section 3.4 for the full pattern. For child widgets, pass pre-cached theme values from the parent:
