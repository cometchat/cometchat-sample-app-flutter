...
TextMessage _$TextMessageFromJson(Map<String, dynamic> json) => TextMessage(
      ...
      failedAt: _$JsonConverterFromJson<int, DateTime>(
          json['failedAt'], const EpochDateTimeConverter().fromJson),
      sentAt: _$JsonConverterFromJson<int, DateTime>(
          json['sentAt'], const EpochDateTimeConverter().fromJson),
      deliveredAt: _$JsonConverterFromJson<int, DateTime>(
          json['deliveredAt'], const EpochDateTimeConverter().fromJson),
      seenAt: _$JsonConverterFromJson<int, DateTime>(
          json['seenAt'], const EpochDateTimeConverter().fromJson),
      updatedAt: _$JsonConverterFromJson<int, DateTime>(
          json['updatedAt'], const EpochDateTimeConverter().fromJson),
      editedAt: _$JsonConverterFromJson<int, DateTime>(
          json['editedAt'], const EpochDateTimeConverter().fromJson),
...
Map<String, dynamic> _$TextMessageToJson(TextMessage instance) =>
    <String, dynamic>{
      ...
      'failedAt': _$JsonConverterToJson<int, DateTime>(
          instance.failedAt, const EpochDateTimeConverter().toJson),
      'sentAt': _$JsonConverterToJson<int, DateTime>(
          instance.sentAt, const EpochDateTimeConverter().toJson),
      'deliveredAt': _$JsonConverterToJson<int, DateTime>(
          instance.deliveredAt, const EpochDateTimeConverter().toJson),
      'seenAt': _$JsonConverterToJson<int, DateTime>(
          instance.seenAt, const EpochDateTimeConverter().toJson),
      ...
      'text': instance.text,
      'linkPreviewData': instance.linkPreviewData,
      'type': instance.$type,
    };
