...
mixin _$User {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, imageSource, createdAt,
...
extension UserPatterns on User {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _User() when $default != null:
        return $default(_that.id, _that.name, _that.imageSource,
            _that.createdAt, _that.metadata);
      case _:
        return orElse();
    }
  }
