...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _waitForCallsSdk() async {
    // CometChatUIKit.login() already triggers CallEventService.instance.init()
    // internally (because enableCalls=true). Just wait for the Calls SDK
    // to be ready rather than double-initializing it.
