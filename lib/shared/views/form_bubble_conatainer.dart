  ...
  return WidgetProps(
    ...
    onTap: () {
      FormMessage formMessage = FormMessage
        (formFields: [
          TextInputElement(elementId: "name", label: "name" , optional: false, ),
        TextInputElement(elementId: "age", label: "Age" , optional: false,),
        SingleSelectElement(elementId: "gender", label: "Gender",
            options: [
              OptionElement(label: "Male",
                value: "male"
              ),
              OptionElement(label: "Female",
                  value: "female"
              )
            ]),
      ...
      ), title: "Survey", receiverUid: "superhero2",
