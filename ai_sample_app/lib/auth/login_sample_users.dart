...
import 'package:ai_sample_app/utils/show_snackBar.dart';
    ...
    try {
      if (user != null) {
        if (user.uid == userId) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const CometChatAIAssistantChat(),
            ),
          );
          return;
        } else {
      ...
      await CometChatUIKit.login(userId, onSuccess: (User loggedInUser) {
        ...
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => const CometChatAIAssistantChat()));
